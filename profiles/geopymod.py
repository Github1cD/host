...
class locate:
    def __init__(self,village=None, 
                 mandal=None, district=None,
                 state=None, country='India', pin= None ):
        self.address = village+' '+ mandal+' '+district+' '+state+' '+ country+' '+ pin
...
class Find_distance():
    def __init__(self,lat1,lon1,lat2,lon2):
        ...
        self.lon2 = lon2
    def distance(self):
        d = geodesic((self.lat1,self.lon1), (self.lat2,self.lon2))
        return d
